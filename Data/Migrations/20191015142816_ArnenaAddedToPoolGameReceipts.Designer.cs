...
namespace TMP2019.Data.Migrations
{
    ...
    [Migration("20191015142816_ArnenaAddedToPoolGameReceipts")]
    partial class ArnenaAddedToPoolGameReceipts
    {
            ...
            modelBuilder.Entity("TMP2019.Models.DataModels.TMPHockeyModels.Game", b =>
                {
                    ...
                    b.Property<int?>("PoolGameReceiptId");
            ...
            modelBuilder.Entity("TMP2019.Models.DataModels.TMPHockeyModels.Game", b =>
                {
                    ...
                    b.HasOne("TMP2019.Controllers.PoolGamesControllers.DataModels.PoolGameReceipt")
                        .WithMany("Games")
                        .HasForeignKey("PoolGameReceiptId");
